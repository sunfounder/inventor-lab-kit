...
Video 28: 7 セグメントディスプレイの使い方
==========================================================

このレッスンでは、Arduino を使って 7 セグメントディスプレイを駆動する方法を説明します。

* **セグメント構成:** セグメントがどのように数字を形成するかを説明します。
* **ピン接続:** セグメントピンの配線方法を実演します。
* **数字表示:** 数字がどのように表示されるかを示します。
* **制御ロジック:** セグメントのオン・オフ制御を実演します。
