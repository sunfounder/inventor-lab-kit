...
Video 26: 赤外線リモコンと受信機の使い方
==========================================================

このレッスンでは、赤外線リモコンが Arduino とどのように通信するかを説明します。

* **赤外線通信:** 赤外線信号がどのように送信・受信されるかを説明します。
* **受信機の配線:** 赤外線受信モジュールの接続方法を実演します。
* **信号のデコード:** リモコンのボタンコードを読み取る方法を示します。
* **コマンド処理:** 赤外線コマンドに応答する方法を実演します。
