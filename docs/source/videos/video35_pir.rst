...
Video 35: 人感赤外線（PIR）センサーの使い方
===================================================================

このレッスンでは、PIR センサーとその動作検知の仕組みを紹介します。

* **PIR の動作:** PIR センサーがどのように動きを検出するかを説明します。
* **デジタル出力:** 動作検知トリガー信号を読み取る方法を実演します。
* **遅延動作:** センサーの遅延時間や保持時間について説明します。
* **動作イベント:** 動きの検出を実演します。
